...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-secondary/50 to-secondary-light">
      <Navbar />
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div
            className={`text-lg md:text-xl text-gray-500 mb-12 max-w-2xl mx-auto animate-fade-up leading-relaxed space-y-4 ${
          ...
          >
            ...
            <p className="space-y-2">
              <span className="relative inline-block">
                <span className="font-semibold">Excel-sheets</span> that are
                hard to manage
                <span
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div
            className="bg-white rounded-2xl shadow-xl overflow-hidden animate-fade-up transform hover:scale-[1.02] transition-transform duration-300"
